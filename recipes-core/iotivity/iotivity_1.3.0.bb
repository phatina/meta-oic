...
branch_libcoap = "IoTivity-1.2.1a"
SRCREV_libcoap = "${branch_libcoap}"
url_libcoap = "git://github.com/dthaler/libcoap.git"
#SRC_URI += "${url_libcoap};name=libcoap;destsuffix=${S}/extlibs/libcoap/libcoap;branch=${branch_libcoap};protocol=http"
...
#ASSUME_SHLIBS = "liboc_logger.so:FILES_${PN}-resource"
